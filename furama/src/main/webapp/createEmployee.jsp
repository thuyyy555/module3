...
<form method="post" action="/employee?action=create">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="luong" name="luong" aria-describedby="luong_txt">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="maViTri" name="maViTri" aria-describedby="maViTri_txt">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="maTrinhDo" name="maTrinhDo" aria-describedby="maTrinhDo_txt">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="maBoPhan" name="maBoPhan" aria-describedby="maBoPhan_txt">
